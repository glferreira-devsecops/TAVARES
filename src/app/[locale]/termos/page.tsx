...
export default async function TermosPage({ params }: PageProps) {
    ...
    const content = {
        pt: {
            ...
            intro: "Ao utilizar os serviços da Favela-República Tour, você concorda com os termos e condições descritos abaixo. Por favor, leia atentamente antes de realizar sua reserva.",
            ...
            sections: [
                ...
                },
                {
                    ...
                    items: [
                        ...
                        "Preços incluem guia local e seguro durante o passeio",
                    ],
                },
                {
                    icon: XCircle,
                ...
                },
                {
                    ...
                    items: [
                        "Seguir as instruções do guia local",
                        "Respeitar a comunidade e seus moradores",
            ...
            sections: [
                ...
                },
                {
                    ...
                    items: [
                        ...
                        "Prices include local guide and insurance",
                    ],
                },
                {
                    icon: XCircle,
                ...
                },
                {
                    ...
                    items: [
                        ...
                        "Respect the community and its residents",
            ...
            sections: [
                ...
                },
                {
                    ...
                    items: [
                        ...
                        "Precios incluyen guía y seguro",
                    ],
                },
                {
                    icon: XCircle,
            ...
            sections: [
                ...
                },
                {
                    ...
                    items: [
                        ...
                        "Les prix incluent le guide et l'assurance",
                    ],
                },
                {
                    icon: XCircle,
                ...
                <div className="container-custom max-w-4xl">
                    ...
                    <div className="mt-8 text-center text-neutral-500">
                        <p>
                            {t.questions}
                            {" "}
                            <a href="mailto:contato@favelarepublicatour.com" className="text-primary-600 hover:underline font-semibold">
