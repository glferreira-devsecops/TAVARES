...
export default async function PrivacidadePage({ params }: PageProps) {
    ...
    const content = {
        pt: {
            ...
            intro: "A Favela-República Tour está comprometida com a proteção da sua privacidade. Esta política explica como coletamos, usamos e protegemos suas informações pessoais.",
