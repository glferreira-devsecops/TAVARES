...
export default async function SocialProjectPage({ params }: PageProps) {
    ...
    const content = {
        pt: {
            ...
            description: "Parte da renda dos nossos tours é revertida para projetos sociais na comunidade. Apoiamos iniciativas de esporte, cultura e educação para as crianças e jovens da Favela."
        },
        en: {
            badge: "Social Impact",
            title: "Transforming Lives",
            description: "Part of the income from our tours is reinvested in social projects within the community. We support sports, culture, and education initiatives for the children and youth of Favela."
        },
        es: {
            badge: "Impacto Social",
            title: "Transformando Vidas",
            description: "Parte de los ingresos de nuestros tours se reinvierte en proyectos sociales en la comunidad. Apoyamos iniciativas de deporte, cultura y educación para los niños y jóvenes de la Favela."
        },
        fr: {
            badge: "Impact Social",
            title: "Transformer des Vies",
            description: "Une partie des revenus de nos visites est réinvestie dans des projets sociaux au sein de la communauté. Nous soutenons des initiatives sportives, culturelles et éducatives pour les enfants et les jeunes de Favela."
        }
    };
