...
const dictionaries: Record<Locale, Dictionary> = {
    pt: {
        ...
        footer: {
            about: "Sobre nós",
            description: "O Favela-República Tour espera por você! Agende seu tour e descubra o Rio de um novo ângulo!",
    ...
    en: {
        ...
        hero: {
            ...
            description: "Explore history, urban art and natural beauty with local conductors. Responsible and immersive tours.",
            ctaMain: "Book Tour Now",
            ctaSecondary: "See Available Tours",
            stats: {
                rating: "Rating",
                safety: "Police Base",
                local: "Local Conductors",
                safeValue: "Safe",
        ...
        footer: {
            about: "About Us",
            description: "The Favela-República Tour awaits you! Book your tour and discover Rio from a new angle!",
        ...
        about: {
            ...
            values: {
                ...
                list: [
                    ...
                    { title: "Community", desc: "Local conductors and direct impact." },
        ...
        AboutPreview: {
            ...
            highlights: {
                ...
                local_guides: { title: "Local Conductors", subtitle: "Born in Favela" },
    ...
    es: {
        ...
        hero: {
            ...
            description: "Descubre la historia, el arte urbano y las bellezas naturales de la comunidad con conductores locales. Tours responsables e inmersivos.",
            ctaMain: "Reservar Tour Ahora",
            ctaSecondary: "Ver Tours Disponibles",
            stats: {
                rating: "Evaluación",
                safety: "Base Policial",
                local: "Conductores Locales",
                safeValue: "Seguro",
        ...
        footer: {
            ...
            description: "¡El Favela-República Tour te espera! ¡Reserva tu tour y descubre Río desde un nuevo ángulo!",
        ...
        about: {
            ...
            values: {
                ...
                list: [
                    ...
                    { title: "Comunidad", desc: "Conductores locales e impacto directo." },
        ...
        AboutPreview: {
            ...
            highlights: {
                ...
                visitors: { title: "1000+", subtitle: "Visitantes" },
                local_guides: { title: "Conductores Locales", subtitle: "Nacidos en la Favela" },
            ...
            features: {
                local_guides: "Conductores locales",
    ...
    fr: {
        ...
        hero: {
            ...
            description: "Découvrez l'histoire, l'art urbain et les beautés naturelles de la communauté avec des conducteurs locaux. Visites responsables et immersives.",
            ctaMain: "Réserver Maintenant",
            ctaSecondary: "Voir les Visites",
            stats: {
                rating: "Évaluation",
                safety: "Base de Police",
                local: "Conducteurs Locaux",
                safeValue: "Sûr",
        ...
        about: {
            ...
            values: {
                ...
                list: [
                    ...
                    { title: "Communauté", desc: "Conducteurs locaux et impact direct." },
        ...
        footer: {
            about: "À Propos",
            description: "Le Favela-República Tour vous attend ! Réservez votre visite et découvrez Rio sous un nouvel angle !",
        ...
        AboutPreview: {
            ...
            highlights: {
                ...
                local_guides: { title: "Conducteurs Locaux", subtitle: "Nés dans la Favela" },
            ...
            features: {
                local_guides: "Conducteurs locaux",
