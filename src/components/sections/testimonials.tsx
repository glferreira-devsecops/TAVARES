...
export function Testimonials({ locale = "pt" }: TestimonialsProps) {
    ...
    // Safety check for dict.Testimonials
    const t = dict.Testimonials || {
        eyebrow: "Depoimentos",
        title: "O que dizem nossos visitantes",
        subtitle: "Mais de 1000 visitantes já viveram essa experiência"
    };
        ...
        <section className="py-20 md:py-32 bg-neutral-900 relative overflow-hidden text-white">
            ...
            <div className="container-custom relative z-10">
                ...
                >
                    ...
                    {/* Mobile View */}
                    <div className="md:hidden relative aspect-[9/16] w-full max-w-[300px] mx-auto rounded-2xl overflow-hidden bg-neutral-900 border border-white/10 shadow-2xl">
