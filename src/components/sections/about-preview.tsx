...
export function AboutPreview({ locale = "pt-br" }: AboutPreviewProps) {
    ...
    return (
        <section id="about" className="py-20 md:py-32 relative overflow-hidden bg-neutral-50 scroll-mt-24">
            ...
            <div className="container-custom relative z-10">
                    ...
                    <div className="relative">
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <motion.div
                                ...
                                className="col-span-2 relative aspect-[16/10] rounded-[2.5rem] overflow-hidden shadow-2xl border-4 border-white"
                            >
                                <Image
                            ...
                            <motion.div
                                ...
                                className="relative aspect-square rounded-[2rem] overflow-hidden shadow-xl border-4 border-white"
                            >
                                <Image
                            ...
                            >
                                <div>
                                    ...
                                    <p className="font-black text-3xl text-neutral-900 tracking-tight">4.9</p>
                ...
                {dict.SocialProject && (
                    ...
                    >
                        <div className="bg-neutral-900 rounded-[3.5rem] p-8 md:p-20 text-white overflow-hidden relative shadow-3xl border border-white/5">
                            ...
                            <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                                ...
                                <div className="order-1 lg:order-2">
                                    ...
                                    <h3 className="font-heading text-4xl md:text-6xl font-black mb-8 leading-[1.05] tracking-tight">
                                        ...
                                        <span className="text-primary-500">{dict.SocialProject.titleHighlight}</span>
                                    </h3>
                                    <div className="space-y-6 text-neutral-300 text-lg md:text-xl leading-relaxed mb-12 font-light">
                                        ...
                                        <p className="font-medium text-white">{dict.SocialProject.description_2}</p>
                                    </div>

                                    <div className="grid grid-cols-3 gap-8 pt-10 border-t border-white/10">
                                        {dict.SocialProject.stats.map((stat, idx) => (
                                            <div key={idx} className="group cursor-default">
                                                <p className="text-3xl md:text-5xl font-black text-primary-500 mb-2 group-hover:scale-110 transition-transform origin-left">{stat.value}</p>
                                                <p className="text-[10px] text-neutral-400 uppercase tracking-[0.2em] font-black leading-tight">{stat.label}</p>
                                            </div>
                                        ))}
                                    </div>
                                </div>
