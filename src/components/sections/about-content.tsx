...
export default function AboutContent({ locale: initialLocale = "pt" }: { locale?: string }) {
    const searchParams = useSearchParams();
    const lang = searchParams.get("lang") ?? initialLocale;
    ...
    return (
        <>
            ...
            {/* Instagram / Community Section - Dark Mode Premium */}
