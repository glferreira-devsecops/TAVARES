...
export function FAQPageClient({ locale }: FAQPageClientProps) {
    ...
    const content = {
        pt: {
            ...
            description: "Encontre respostas para as perguntas mais comuns sobre os tours na Favela. Se não encontrar o que procura, entre em contato!",
        ...
        en: {
            ...
            description: "Find answers to the most common questions about tours in Favela. If you can't find what you're looking for, contact us!",
        ...
        es: {
            ...
            description: "Encuentra respuestas a las preguntas más comunes sobre los tours en Favela. Si no encuentras lo que buscas, ¡contáctanos!",
        ...
        fr: {
            ...
            description: "Trouvez les réponses aux questions les plus courantes sur les visites à Favela. Si vous ne trouvez pas ce que vous cherchez, contactez-nous!",
