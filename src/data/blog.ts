...
export const blogPosts: BlogPost[] = [
    {
        ...
        excerpt: {
            pt: "Descubra a fascinante história de quase um século da comunidade Favela...",
            en: "Discover the fascinating nearly century-old history of the Favela community...",
            es: "Descubre la historia de la comunidad Favela.",
            fr: "Découvrez l'histoire de la communauté Favela."
        },
        content: {
            pt: `## As Origens (1931)...`,
            en: `## The Origins (1931)...`,
    ...
    },
    {
        ...
        excerpt: {
            pt: "Aprenda a diferenciar turismo exploratório de turismo comunitário...",
            en: "Learn to differentiate exploitative tourism from community tourism...",
        ...
        tags: {
            ...
            es: ["turismo responsable", "turismo comunitario", "favela", "ética"],
            fr: ["tourisme responsável", "tourisme communautaire", "favela", "éthique"]
        },
