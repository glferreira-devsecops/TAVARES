...
The success of Favela shows that it is possible to develop tourism that directly benefits communities, valuing their culture and history without exploitation or stereotypes.`,
        ...
        image: "/images/tours/IMG_7268.webp",
        readTime: 8,
        featured: true,
    },
    {
...
Ao longo de mais de 40 anos, Bob foi expandindo sua construção de maneira orgânica:

- **Mosaicos**: As paredes são cobertas por intrincados mosaicos coloridos, obra do próprio Bob
- **Vista panorâmica**: O terraço oferece uma das vistas mais espetaculares do Rio, com o Pão de Açúcar e a Baía de Guanabara
- **Salas temáticas**: Cada ambiente tem sua própria personalidade e história
- **Galeria de arte**: Obras de artistas locais e internacionais decoram os corredores

## As Noites de Jazz

The Maze se tornou mundialmente famoso por suas noites de jazz, realizadas uma vez por mês. A revista americana Downbeat reconheceu o espaço como uma das 150 melhores casas de jazz do mundo — um feito impressionante para um local situado em uma favela.

Músicos de todo o mundo passaram pelo Maze:
- Artistas de jazz internacionais
- Músicos locais cariocas
- DJs e produtores
- Artistas performáticos

## Impacto na Comunidade

Bob Nadkarni não era apenas um artista estrangeiro vivendo na favela — ele se integrou completamente à comunidade:
...
Como qualquer empreendimento de longa data, The Maze enfrentou desafios:

- **Disputas legais**: Em 2019, questões com vizinhos levaram a uma interrupção temporária
...
Over more than 40 years, Bob expanded his construction organically:

- **Mosaics**: The walls are covered with intricate colorful mosaics, Bob's own work
- **Panoramic view**: The terrace offers one of Rio's most spectacular views, with Sugarloaf and Guanabara Bay
- **Themed rooms**: Each space has its own personality and history
- **Art gallery**: Works by local and international artists decorate the corridors

## Jazz Nights

The Maze became world-famous for its jazz nights, held once a month. American magazine Downbeat recognized the space as one of the 150 best jazz houses in the world — an impressive feat for a location in a favela.

Musicians from around the world passed through the Maze:
...
Bob Nadkarni was not just a foreign artist living in the favela — he fully integrated into the community:
...
Like any long-standing venture, The Maze faced challenges:

- **Legal disputes**: In 2019, neighbor issues led to a temporary interruption
...
Bob Nadkarni created more than a house — he created a legacy that shows how art can transform communities and connect cultures.`,
        ...
        image: "/images/tours/IMG_0417.webp",
        readTime: 6,
        featured: true,
    },
    {
...
Panmela Castro, também conhecida pelo nome artístico "Anarkia Boladona", é uma das mais importantes grafiteiras do Brasil. Nascida no Rio de Janeiro, ela começou a grafitar nas ruas da cidade e rapidamente ganhou reconhecimento por seu estilo único, caracterizado por retratos femininos fortes e expressivos.

Sua arte não é apenas estética — é uma ferramenta de transformação social. Panmela usa o grafite para abordar temas como violência doméstica, direitos das mulheres, racismo e desigualdade social.

## O Trauma que Virou Missão

A trajetória de Panmela como ativista tem raízes em sua própria história. Como sobrevivente de violência doméstica, ela entendeu na pele a importância de dar voz às mulheres que sofrem em silêncio.

Em vez de se calar, Panmela escolheu os muros das cidades como sua plataforma. Seus grafites passaram a carregar mensagens sobre a Lei Maria da Penha, sobre empoderamento feminino e sobre a necessidade de quebrar o ciclo de violência.

## A Fundação da Rede NAMI (2010)

Em 2010, Panmela fundou a Rede NAMI, uma organização sem fins lucrativos dedicada a:

- **Ensinar grafite para mulheres e meninas**: Workshops que capacitam mulheres a se expressarem através da arte urbana
- **Criar murais com mensagens sociais**: Produzir arte que educa e conscientiza
...
1. **Murais de artistas brasileiras**: Obras de grafiteiras de todo o país
2. **Arte internacional**: Contribuições de artistas mulheres do mundo inteiro
3. **Mensagens de empoderamento**: Frases e imagens sobre direitos femininos
4. **Cores vibrantes**: Uma explosão visual que transforma as ruas da comunidade
5. **Arte interativa**: Murais que convidam à reflexão e ao diálogo

## Impacto Social

O trabalho de Panmela e da Rede NAMI vai muito além da estética:

- **Mais de 10.000 mulheres** já participaram de workshops de grafite
- **Reconhecimento internacional**: Panmela foi premiada e participou de eventos globais
- **Mudança de narrativa**: A arte ajuda a combater estereótipos sobre favelas e mulheres
- **Turismo responsável**: Os murais atraem visitantes que contribuem para a economia local

## Uma Galeria Democrática

Diferente de museus tradicionais, o Museu Vivo NAMI é:

- **Gratuito e acessível**: Qualquer pessoa pode caminhar pelas ruas e apreciar a arte
- **Em constante evolução**: Novos murais são criados regularmente
- **Parte da comunidade**: Os moradores convivem diariamente com as obras
- **Educativo**: Cada mural conta uma história e transmite uma mensagem
...
Panmela Castro, also known by the artistic name "Anarkia Boladona", is one of Brazil's most important graffiti artists. Born in Rio de Janeiro, she started painting on the city's streets and quickly gained recognition for her unique style, characterized by strong and expressive female portraits.

Her art is not just aesthetic — it's a tool for social transformation. Panmela uses graffiti to address themes such as domestic violence, women's rights, racism, and social inequality.

## The Trauma That Became a Mission

Panmela's trajectory as an activist is rooted in her own history. As a domestic violence survivor, she understood firsthand the importance of giving voice to women who suffer in silence.

Instead of remaining silent, Panmela chose city walls as her platform. Her graffiti began carrying messages about the Maria da Penha Law, about female empowerment, and about the need to break the cycle of violence.

## The Foundation of Rede NAMI (2010)

In 2010, Panmela founded Rede NAMI, a non-profit organization dedicated to:

- **Teaching graffiti to women and girls**: Workshops that empower women to express themselves through urban art
- **Creating murals with social messages**: Producing art that educates and raises awareness
...
1. **Murals by Brazilian artists**: Works by women graffiti artists from across the country
2. **International art**: Contributions from women artists worldwide
3. **Empowerment messages**: Phrases and images about women's rights
4. **Vibrant colors**: A visual explosion that transforms community streets
5. **Interactive art**: Murals that invite reflection and dialogue

## Social Impact

The work of Panmela and Rede NAMI goes far beyond aesthetics:

- **Over 10,000 women** have participated in graffiti workshops
- **International recognition**: Panmela has been awarded and participated in global events
- **Narrative change**: Art helps combat stereotypes about favelas and women
- **Responsible tourism**: The murals attract visitors who contribute to the local economy

## A Democratic Gallery

Unlike traditional museums, the Living Museum NAMI is:

- **Free and accessible**: Anyone can walk through the streets and appreciate the art
- **Constantly evolving**: New murals are created regularly
- **Part of the community**: Residents live daily with the works
- **Educational**: Each mural tells a story and conveys a message
...
Panmela Castro proved that art can be born from pain and transform into healing — not just for the artist, but for an entire community.`,
        ...
        image: "/images/tours/IMG_2991.webp",
        readTime: 7,
        featured: true,
    },
    {
...
Lançado pela EA Sports, o FIFA Street foi um fenômeno dos anos 2000. Diferente do FIFA tradicional, focado em simulação realista, o FIFA Street celebrava o futebol de rua: dribles impossíveis, jogadas acrobáticas e cenários urbanos autênticos.

O jogo vendeu milhões de cópias em todo o mundo e marcou uma geração de jogadores que cresceram sonhando em fazer um "panna" ou um "around the world" como seus ídolos virtuais.
...
- **Palco de eventos**: Torneios, festas e comemorações
- **Ponto turístico**: Visitantes do mundo inteiro vêm conhecer o local
...
3. **A atmosfera**: O som da bola, as torcidas, o clima informal
4. **A história**: Saber que aquele chão de concreto inspirou um fenômeno mundial

## A Foto 360°

Um morador local desenvolveu uma experiência especial: uma foto 360° que coloca você "dentro" do cenário do jogo. É a oportunidade perfeita para registrar sua visita e compartilhar nas redes sociais.

## Legado do FIFA Street

Embora os jogos da série FIFA Street tenham sido descontinuados, seu legado permanece:
...
A quadra do FIFA Street é uma parada obrigatória no nosso Tour Completo. Nossos guias contam toda a história, explicam a conexão com o jogo e, se você tiver disposição, organizam uma pelada com os moradores locais.

É a chance de sair do virtual e viver a experiência real do futebol de rua brasileiro.`,
            en: `## The FIFA Street Phenomenon

Released by EA Sports, FIFA Street was a 2000s phenomenon. Unlike the traditional FIFA, focused on realistic simulation, FIFA Street celebrated street football: impossible dribbles, acrobatic plays, and authentic urban settings.

The game sold millions of copies worldwide and marked a generation of players who grew up dreaming of doing a "panna" or an "around the world" like their virtual idols.
...
- **Event venue**: Tournaments, parties, and celebrations
- **Tourist spot**: Visitors from around the world come to see the location
...
3. **The atmosphere**: The sound of the ball, the cheering, the informal vibe
4. **The history**: Knowing that this concrete floor inspired a global phenomenon

## The 360° Photo

A local resident developed a special experience: a 360° photo that puts you "inside" the game scene. It's the perfect opportunity to record your visit and share on social media.

## FIFA Street's Legacy

Although the FIFA Street game series has been discontinued, its legacy remains:
...
The FIFA Street court is a must-stop on our Complete Tour. Our guides tell the whole story, explain the connection with the game, and if you're up for it, organize a pickup game with local residents.

It's the chance to leave the virtual and live the real experience of Brazilian street football.`,
        },
        author: "Favela-República",
        ...
        image: "/images/tours/IMG_5965.webp",
        readTime: 5,
        featured: false,
    },
    {
        ...
        title: {
            pt: "Turismo Responsável em Favelas: O Guia Completo para Fazer a Escolha Certa",
            en: "Responsible Favela Tourism: The Complete Guide to Making the Right Choice",
        },
        excerpt: {
            pt: "Nem todo tour de favela é igual. Aprenda a diferenciar turismo exploratório de turismo comunitário e como garantir que sua visita beneficie diretamente a comunidade.",
            en: "Not all favela tours are the same. Learn to differentiate exploitative tourism from community tourism and how to ensure your visit directly benefits the community.",
        },
        content: {
            pt: `## O Dilema do Turismo em Favelas

O turismo em favelas é um tema controverso. Críticos argumentam que pode ser voyeurístico e explorador; defensores apontam os benefícios econômicos para as comunidades. A verdade é que tudo depende de como o turismo é conduzido.

## Turismo Exploratório vs. Turismo Comunitário

### Turismo Exploratório (evite):
- Guias de fora da comunidade que não conhecem a realidade local
- Tours de "jipe" que passam rapidamente sem interação
- Nenhuma contribuição financeira para a comunidade
- Foco em "pobreza" como atração
- Fotografias invasivas de moradores

### Turismo Comunitário (escolha):
- Guias locais que moram na comunidade
- Caminhadas que permitem interação real
- Renda direcionada para moradores e projetos sociais
- Foco em cultura, arte e história
- Respeito à privacidade dos moradores

## Como Identificar um Tour Responsável

Antes de reservar, pergunte:

1. **Quem são os guias?** Moradores locais são a melhor opção
2. **Para onde vai o dinheiro?** Parte significativa deve ficar na comunidade
3. **Qual é o foco do tour?** Cultura, arte e história são bons indicativos
4. **Como são as fotografias?** Tours responsáveis orientam sobre respeito e consentimento
5. **Existe parceria com a comunidade?** Projetos sociais locais devem ser apoiados

## Os Benefícios do Turismo Bem Feito

Quando feito da maneira certa, o turismo comunitário:

- **Gera emprego**: Guias, motoristas, comerciantes locais se beneficiam
- **Financia projetos**: Educação, cultura, saúde podem receber recursos
- **Combate estereótipos**: Visitantes saem com uma visão mais completa e humana
...
1. **100% dos guias são moradores locais**
2. **Parcerias com projetos como a Rede NAMI**
3. **Foco em arte urbana, história e cultura**
4. **Grupos pequenos que permitem interação genuína**
5. **Orientações claras sobre fotografias e respeito**

## Dicas Práticas para Visitantes

- **Vista-se de forma simples**: Evite ostentação
- **Deixe o celular no bolso** quando interagir com moradores
- **Pergunte antes de fotografar**: Especialmente crianças
- **Compre de comércios locais**: Apoie a economia da comunidade
- **Escute mais do que fale**: A visita é para aprender

## Conclusão

Turismo em favelas pode ser uma força positiva e transformadora. A chave está na escolha: opte por empresas comprometidas com a comunidade, prepare-se para uma experiência de aprendizado e saia como um embaixador da verdadeira história das favelas brasileiras.`,
            en: `## The Favela Tourism Dilemma

Favela tourism is a controversial topic. Critics argue it can be voyeuristic and exploitative; defenders point to economic benefits for communities. The truth is that everything depends on how tourism is conducted.

## Exploitative Tourism vs. Community Tourism

### Exploitative Tourism (avoid):
- Guides from outside the community who don't know the local reality
- "Jeep" tours that pass quickly without interaction
- No financial contribution to the community
- Focus on "poverty" as attraction
- Invasive photography of residents

### Community Tourism (choose):
- Local guides who live in the community
- Walks that allow real interaction
- Income directed to residents and social projects
- Focus on culture, art, and history
- Respect for residents' privacy

## How to Identify a Responsible Tour

Before booking, ask:

1. **Who are the guides?** Local residents are the best option
2. **Where does the money go?** A significant portion should stay in the community
3. **What is the tour's focus?** Culture, art, and history are good indicators
4. **How are photographs handled?** Responsible tours guide on respect and consent
5. **Is there community partnership?** Local social projects should be supported

## Benefits of Well-Done Tourism

When done the right way, community tourism:

- **Generates employment**: Guides, drivers, local merchants benefit
- **Funds projects**: Education, culture, health can receive resources
- **Fights stereotypes**: Visitors leave with a more complete and human vision
...
1. **100% of guides are local residents**
2. **Partnerships with projects like Rede NAMI**
3. **Focus on street art, history, and culture**
4. **Small groups that allow genuine interaction**
5. **Clear guidelines on photography and respect**

## Practical Tips for Visitors

- **Dress simply**: Avoid ostentation
- **Keep your phone in your pocket** when interacting with residents
- **Ask before photographing**: Especially children
- **Buy from local businesses**: Support the community economy
- **Listen more than you speak**: The visit is for learning

## Conclusion

Favela tourism can be a positive and transformative force. The key is in the choice: opt for companies committed to the community, prepare for a learning experience, and leave as an ambassador for the true story of Brazilian favelas.`,
        },
        author: "Favela-República",
        ...
        image: "/images/social/IMG_0546.webp",
        readTime: 6,
        featured: false,
    },
];
...
export function getBlogPostsByCategory(category: string): BlogPost[] {
    return blogPosts.filter(
        (post) => post.category.pt.toLowerCase() === category.toLowerCase() ||
