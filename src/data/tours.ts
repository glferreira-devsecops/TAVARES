...
export const tours: Tour[] = [
    {
        ...
        description: {
            pt: `Comece o tour no ponto mais alto da favela, em um ambiente seguro e acolhedor. Caminhe por becos e vielas e vivencie de perto a cultura, a história e o cotidiano da comunidade, com liberdade total para fotos e vídeos durante todo o percurso.
...
O tour segue pela quadra de futebol famosa por ter sido cenário do FIFA Street, onde você pode gravar um vídeo 360° exclusivo, passa pelo Centro Social Dona Irene, que desenvolve projetos sociais na comunidade, e pelo Campo Pelé, onde crianças treinam e vivem a paixão local pelo futebol.
...
Mais do que um passeio, o Favela-República promove turismo responsável, troca cultural e valorização social, oferecendo uma experiência real, segura e transformadora.`,
            en: "Start the tour at the highest point of the favela. Walk through alleys and experience the culture, history, and daily life of the community. Includes coffee with cake at a resident's home, visit to The Maze, FIFA Street court, Dona Irene Social Center, and Pelé Field.",
            es: "Comience el tour en el punto más alto de la favela. Camine por callejones y viva la cultura, historia y vida cotidiana de la comunidad. Incluye café con pastel en casa de una residente, visita a The Maze, cancha FIFA Street, Centro Social Dona Irene y Campo Pelé.",
        ...
        included: {
            ...
            en: ["Bilingual local guide", "Round trip transport from favela", "Entrance to The Maze (when open)", "360° Video", "Photos by the team"],
            es: ["Guía local bilingüe", "Transporte ida y vuelta de la favela", "Entrada a The Maze (cuando abierto)", "Video 360°", "Fotos hechas por el equipo"],
            fr: ["Guide local bilingue", "Transport aller-retour de la favela", "Entrée au The Maze (quand ouvert)", "Vidéo 360°", "Photos prises par l'équipe"]
        },
        notIncluded: {
        ...
        images: ["/images/tours/IMG_7268.webp"]
    },
    {
...
Explore a favela além dos estereótipos, um território cheio de história, arte urbana vibrante, hospitalidade e energia contagiante. Sinta-se seguro para caminhar, conversar e vivenciar de perto a cultura que transformou o futebol em paixão e identidade brasileira.`,
        ...
        included: {
            ...
            en: ["Bilingual local guide", "Round trip transport", "2h game at FIFA STREET court", "360° Video", "Photos by team"],
            es: ["Guía local bilingüe", "Transporte ida y vuelta", "2h de juego en cancha FIFA STREET", "Video 360°", "Fotos equipo"],
            fr: ["Guide local bilingue", "Transport aller-retour", "2h de jeu sur terrain FIFA STREET", "Vidéo 360°", "Photos équipe"]
        },
        notIncluded: {
            pt: ["Refeições e bebidas", "Gorjetas (opcionais)"],
            en: ["Meals and drinks", "Tips (optional)"],
        ...
        images: ["/images/tours/IMG_5965.webp"]
    },
    {
        id: "samba-na-favela",
...
Durante o tour, explore os becos e vielas da comunidade acompanhado por um condutor local, conhecendo histórias, tradições e personagens que mantêm viva a essência do samba. Uma imersão vibrante que revela a força, o encanto e a emoção dessa expressão que traduz a alma brasileira.`,
            en: "Experience the true rhythm of Brazil. Learn samba steps with locals, diving into the culture that makes Rio's heart beat. Explore the alleys with a local guide, knowing stories and characters of samba.",
            es: "Experimente el verdadero ritmo de Brasil. Aprenda pasos de samba con locales, sumergiéndose en la cultura que hace latir el corazón de Río. Explore los callejones con un guía local, conociendo historias y personajes de la samba.",
            fr: "Vivez le vrai rythme du Brésil. Apprenez des pas de samba avec des locaux, plongeant dans la culture qui fait battre le cœur de Rio. Explorez les ruelles avec un guide local, découvrant histoires et personnages de la samba."
        },
        shortDescription: {
        ...
        included: {
            ...
            en: ["Bilingual local guide", "Round trip transport", "Samba class with local teacher", "360° Video", "Photos by team"],
            es: ["Guía local bilingüe", "Transporte ida y vuelta", "Clase de samba con profesora local", "Video 360°", "Fotos equipo"],
            fr: ["Guide local bilingue", "Transport aller-retour", "Cours de samba avec prof locale", "Vidéo 360°", "Photos équipe"]
        },
        notIncluded: {
            pt: ["Refeições e bebidas", "Gorjetas (opcionais)"],
            en: ["Meals and drinks", "Tips (optional)"],
        ...
        images: ["/images/tours/IMG_9641.webp"]
    },
    {
...
Durante o tour, vivencie o espírito do esporte dentro da favela, conheça histórias de atletas que encontraram no jiu-jitsu um caminho de transformação e sinta a força dessa prática que conecta corpo, mente e cultura. Uma imersão que revela o verdadeiro espírito do Brasil através do esporte.`,
        ...
        included: {
            ...
            en: ["Bilingual local guide", "Round trip transport", "Jiu-jitsu class with professional teacher", "360° Video", "Photos by team"],
            es: ["Guía local bilingüe", "Transporte ida y vuelta", "Clase de jiu-jitsu", "Video 360°", "Fotos equipo"],
            fr: ["Guide local bilingue", "Transport aller-retour", "Cours de jiu-jitsu", "Vidéo 360°", "Photos équipe"]
        },
        notIncluded: {
            pt: ["Refeições e bebidas", "Gorjetas (opcionais)"],
            en: ["Meals and drinks", "Tips (optional)"],
        ...
        images: ["/images/tours/IMG_7835.webp", "/images/tours/IMG_7837.webp", "/images/tours/IMG_7838.webp"]
    },
    {
        ...
        description: {
            pt: `Sinta o ritmo do Brasil em uma experiência vibrante com músicos e moradores locais. Aprenda a tocar instrumentos autênticos do samba e do carnaval com integrantes da escola de samba da comunidade, descobrindo a história, o significado e a importância dessa tradição para a cultura brasileira.
...
Durante o tour, vivencie a energia contagiante das batidas que embalam o carnaval e fazem parte do cotidiano das favelas cariocas. Essa imersão une aprendizado, música e cultura, revelando como o samba expressa a alegria, a criatividade e o espírito coletivo do verdadeiro Brasil.`,
            en: "Feel the rhythm of Brazil. Learn to play authentic samba and carnival instruments with members of the community samba school. Experience the contagious energy of the beats.",
        ...
        included: {
            ...
            en: ["Bilingual local guide", "Round trip transport", "Percussion class", "360° Video", "Photos by team"],
            es: ["Guía local bilingüe", "Transporte ida y vuelta", "Clase de percusión", "Video 360°", "Fotos equipo"],
            fr: ["Guide local bilingue", "Transport aller-retour", "Cours de percussion", "Vidéo 360°", "Photos équipe"]
        },
        notIncluded: {
            pt: ["Refeições e bebidas", "Gorjetas (opcionais)"],
            en: ["Meals and drinks", "Tips (optional)"],
        ...
        images: ["/images/tours/IMG_8882.webp", "/images/tours/IMG_9593.webp", "/images/tours/IMG_9641.webp"]
    },
    {
...
É uma experiência autêntica, leve e cheia de alegria! A favela é acolhedora, vibrante e rica em tradição. Caminhe, converse, observe e se conecte com uma cultura que transforma a capoeira em arte, união e identidade brasileira.`,
        ...
        included: {
            ...
            en: ["Bilingual local guide", "Round trip transport", "Capoeira class", "360° Video", "Photos by team"],
            es: ["Guía local bilingüe", "Transporte ida y vuelta", "Clase de capoeira", "Video 360°", "Fotos equipo"],
            fr: ["Guide local bilingue", "Transport aller-retour", "Cours de capoeira", "Vidéo 360°", "Photos équipe"]
        },
        notIncluded: {
            pt: ["Refeições e bebidas", "Gorjetas (opcionais)"],
            en: ["Meals and drinks", "Tips (optional)"],
        ...
        images: ["/images/tours/IMG_6258.webp"]
    },
    {
        ...
        description: {
            pt: `Entre na favela e descubra onde os ritmos brasileiros ganham vida. Nas ruas, becos e praças, samba, funk, pagode e outros sons se misturam com a energia da comunidade. A música nasce naturalmente: rodas de samba na calçada, batidas improvisadas com palmas e latas, pagode animando os vizinhos e o som dos bailes que movimenta todo mundo.
...
Aqui você vive tudo de perto, aprende passos simples, sente o ritmo no corpo e conhece moradores que respiram música todos os dias. A favela é cultura, alegria e acolhimento. Dance, escute e se conecte com essa energia que transforma qualquer momento em festa.`,
            en: "Discover where Brazilian rhythms come to life. Samba, funk, pagode mix with community energy. Learn simple steps, feel the rhythm, and meet residents who breathe music.",
            es: "Descubra dónde los ritmos brasileños cobran vida. Samba, funk, pagode se mezclan con la energía de la comunidad. Aprenda pasos simples, sienta el ritmo y conozca residentes que respiran música.",
            fr: "Découvrez où les rythmes brésiliens prennent vie. Samba, funk, pagode se mêlent à l'énergie de la communauté. Apprenez des pas simples, ressentez le rythme et rencontrez des habitants qui respirent la musique."
        },
        shortDescription: {
        ...
        included: {
            ...
            en: ["Bilingual local guide", "Round trip transport", "Dance class", "360° Video", "Photos by team"],
            es: ["Guía local bilingüe", "Transporte ida y vuelta", "Clase de baile", "Video 360°", "Fotos equipo"],
            fr: ["Guide local bilingue", "Transport aller-retour", "Cours de danse", "Vidéo 360°", "Photos équipe"]
        },
        notIncluded: {
            pt: ["Refeições e bebidas", "Gorjetas (opcionais)"],
            en: ["Meals and drinks", "Tips (optional)"],
        ...
        images: ["/images/tours/IMG_0440.webp"]
    }
];
